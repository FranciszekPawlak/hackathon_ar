...
export default function CoordinatesForm({ setForm, setCurrentPosition, form }: any) {
    ...
    return (
        <form onSubmit={submit} style={{
            ...
            {form.latitude && form.longitude && <span style={{ backgroundColor: "gray", padding: "4px 8px" }}>{`latitude: ${form.latitude} longitude: ${form.longitude}`}</span>}
        </form>
    )
}